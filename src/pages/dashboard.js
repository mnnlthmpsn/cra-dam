...
const Dashboard = () => {
    return (
        <div>
            <AuthNav />
            <h4 class="text-center" style={{ marginTop: "24px", marginBottom: "24px" }}>Enrolled Courses</h4>
            <div class="container">
                        ...
                        <div class="product-container">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="row">
                                        <Link to='/course/6/detail'><div class="col-6"><button class="btn btn-light" type="button" style={{ backgroundColor: "rgb(40,167,69)" }}>Continue Reading</button></div></Link>
                                    </div>
                                </div>
                            </div>
                        </div>
